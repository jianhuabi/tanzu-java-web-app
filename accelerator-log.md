...
```json
{
  ...
  "repositoryPrefix" : "harbor.dragonstone.tkg-aws-e2-lab.winterfell.be/agile/supply-chain"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->harbor.dragonstone.t...(truncated)]
